...
//         try {
//             // If not logged in, use guest cart from localStorage
//             if (!isLoggedIn()) {
...
//             // Otherwise fetch cart from server
...
//                     fetchCartItem(); // Refresh cart from localStorage
//                 }
//                 return result;
//             }
...
//     // When user logs in, merge the guest cart with their account
//     useEffect(() => {
//         if (isLoggedIn()) {
//             mergeCartAfterLogin(Axios);
//         }
//     }, [user]);
