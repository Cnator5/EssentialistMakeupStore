        ...
        <div className="flex flex-wrap md:grid md:grid-cols-4 gap-4 sm:gap-6 md:gap-10">
          <div className="flex-[1_1_220px] min-w-[180px] max-w-full mb-4 md:mb-0">
            ...
            <div className="space-y-2 font-bold text-xs sm:text-sm">
              <div className="flex items-center text-black">
                ...
                <a href="mailto:esssmakeup@gmail.com" className="hover:text-pink-500 transition duration-300 text-black">esssmakeup@gmail.com</a>
              </div>
              <div className="flex items-center text-black">
                <span className="inline-block mr-2">📱</span>
          ...
          <div className="flex-[1_1_180px] min-w-[150px] max-w-full mb-4 md:mb-0">
            ...
            <ul className="block space-y-2 sm:space-y-3 mb-3 sm:mb-5 text-xs sm:text-base">
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">How To Shop</Link></li>
              <li><Link to="/cart" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Payments</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Shipping</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Returns Policy</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Terms and Conditions</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Frequently Asked Questions</Link></li>
            </ul>
            <div>
              <h3 className="text-black font-bold mb-2 sm:mb-3 text-xs sm:text-base">Payment Methods:</h3>
              <div className="flex flex-row items-center flex-wrap gap-2">
                <img src={orange} alt="Orange logo" className="w-8 sm:w-12 md:w-16 h-6 sm:h-10 object-contain" />
                <img src={mtnlogo} alt="MTN logo" className="w-8 sm:w-12 md:w-16 h-6 sm:h-10 object-contain" />
                <img src={stripe} alt="Stripe logo" className="w-10 sm:w-14 md:w-20 h-6 sm:h-10 object-contain" />
              </div>
            </div>
          </div>
          <div className="flex-[1_1_180px] min-w-[150px] max-w-full mb-4 md:mb-0">
            ...
            <ul className="block space-y-2 sm:space-y-3 mb-3 sm:mb-5 text-xs sm:text-base">
              <li><Link to="/profile" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Profile</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Cart</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">My Basket</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Returns Policy</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Register</Link></li>
              <li><Link to="#" className="text-black font-bold md:font-normal hover:text-pink-500 transition duration-300">Blog</Link></li>
            </ul>
            <div>
              <h3 className="text-black font-bold mb-2 sm:mb-3 text-xs sm:text-base">Stay Connected:</h3>
              <div className="flex flex-row items-center flex-wrap gap-2">
                <a href="https://www.facebook.com/Essentialistmakeupstore" target="_blank" rel="noopener noreferrer" className="bg-blue-600 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:opacity-90 transition duration-300">
                  <FaFacebook size={18} color="white" />
                </a>
                <a href="https://www.instagram.com/Essentialistmakeupstore" target="_blank" rel="noopener noreferrer" className="bg-black w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:opacity-90 transition duration-300 border border-white">
                  <FaInstagram size={18} color="white" />
                </a>
                <a href="https://www.youtube.com/Essentialistmakeupstore" target="_blank" rel="noopener noreferrer" className="bg-rose-600 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:opacity-90 transition duration-300">
                  <FaYoutube size={18} color="white" />
                </a>
                <a href="https://www.whatsapp.com/Essentialistmakeupstore" target="_blank" rel="noopener noreferrer" className="bg-green-600 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:opacity-90 transition duration-300">
                  <FaWhatsapp size={18} color="white" />
                </a>
                <a href="https://www.tiktok.com/@essentialistmakeupstore" target="_blank" rel="noopener noreferrer" className="bg-black w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:opacity-90 transition duration-300">
          ...
          <div className="flex-[1_1_200px] min-w-[170px] max-w-full">
            ...
            <div className="flex flex-row items-center flex-wrap gap-2 sm:gap-4 mb-4 sm:mb-6">
              <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" className="flex-1 min-w-[90px] max-w-[140px]">
                <img
                  src={google_play}
                  alt="Google Play"
              ...
              <a href="https://apple.com/app-store" target="_blank" rel="noopener noreferrer" className="flex-1 min-w-[90px] max-w-[140px]">
                <img
                  src={app_store}
                  alt="App Store"
                  className="w-full h-10 sm:h-16 md:h-20 object-contain rounded-lg shadow-lg transition-transform duration-200 hover:scale-105"
            ...
            <p className="text-black text-xs sm:text-sm font-bold md:font-normal">
              Is there a product you cannot find on our website? Do tell us <Link to="/contact" className="text-pink-500 hover:underline">here!</Link>
            </p>
          </div>
        </div>
