...
const CategoryWiseProductDisplay = ({ id, name }) => {
    ...
    return (
        <div>
            ...
            <div className="container mx-auto px-4 flex items-center justify-between mb-2  p-20 ">
                {/* Centered name */}
                <div className="flex-1 flex justify-center">
                    <h1 className="font-bold text-[60px] md:text-[60px] text-center">
                    {name}
                    </h1>
                </div>
            </div>
                ...
                <div className="flex-1 flex justify-end">
                    <Link
                        to={redirectURL}
                        className="text-pink-400 hover:text-green-400 font-bold"
                    >
                        See All
                    </Link>
                </div>
