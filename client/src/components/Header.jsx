...
const Header = () => {
    ...
    // Check if sidebar should be shown (not on dashboard pages)
                    ...
                    <div className="block bg-white text-black">
                        <div className="block text-black ">
                            <ul className="flex flex-col ">
                                <li>
                                    <Link to="/" className="block text-black px-4 hover:text-purple-400 border-gray-700" onClick={() => setMobileMenuOpen(false)}>HOME</Link>
                                </li>
                                {/* <li className="px-4">
                                    <Dropdown />
                                </li> */}
                                <li>
                                    <Link to="/brands" className="block text-black px-4 py-4 hover:text-purple-400  border-gray-700" onClick={() => setMobileMenuOpen(false)}>BRANDS</Link>
                                </li>
                                <li>
                                    <Link to="/new-arrival" className="block text-black px-4 py-4 hover:text-purple-400  border-gray-700" onClick={() => setMobileMenuOpen(false)}>NEW & HOT</Link>
                                </li>
                                <li>
                                    <Link to="/contact" className="block text-black px-4 py-4 hover:text-purple-400  border-gray-700" onClick={() => setMobileMenuOpen(false)}>CONTACT US</Link>
                                </li>
                                {/* SALES & OFFERS DROPDOWN (mobile) */}
