...
//       "
//     >
//       <div className="bg-gradient-to-r from-pink-300 to-pink-400 p-2">
...
//               <div className="h-4 bg-gray-100 rounded w-1/2 ml-3 mb-2"></div>
//               <div className="h-4 bg-gray-100 rounded w-2/3 ml-3"></div>
//             </div>
//           ))
//         ) : (
...
//                 <div className="w-full px-6 py-3 flex items-center hover:bg-pink-50 transition-colors">
...
//                           className="text-sm text-gray-600 py-1 px-2 rounded hover:bg-pink-100 hover:text-pink-600 cursor-pointer transition-colors"
//                         >
//                           {subCat.name}
//                         </li>
//                       ))}
