...
import bannerMobile from "../assets/staymattebutnotflatpowderfoundationmain.jpg";
...
const Login = () => {
  ...
  // Uncomment and implement if Google sign-in is needed
        ...
        >
          ...
          {/* <div className="my-6">
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-6 w-full flex items-center justify-center gap-2 py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-pink-50 transition-colors disabled:opacity-50"
            >
